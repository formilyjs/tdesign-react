...
type ActiveKeys = Array<string | number>
...
type ComposedFormCollapse = React.FC<IFormCollapseProps> & {
  CollapsePanel?: React.FC<TdCollapsePanelProps>
...
export const FormCollapse: ComposedFormCollapse = observer(
  ({ formCollapse, ...props }) => {
    ...
    const takeActiveKeys = () => {
      ...
      if (props.expandMutex) return [panels[0]?.name]
...
const CollapsePanel: React.FC<TdCollapsePanelProps> = ({ children }) => {
