...
import { Popup, PopupProps } from 'tdesign-react'
import { EditIcon, CloseIcon, ChatIcon } from 'tdesign-icons-react'
...
export const Editable: ComposedEditable = observer((props) => {
  ...
  const renderEditHelper = () => {
    ...
    return (
      <BaseItem {...props} {...itemProps}>
        {pattern === 'editable' && (
          <EditIcon className={`${prefixCls}-edit-btn`} />
        )}
        {pattern !== 'editable' && (
          <ChatIcon className={`${prefixCls}-edit-btn`} />
        )}
      </BaseItem>
    )
  }
  ...
  const renderCloseHelper = () => {
    ...
    return (
      <BaseItem {...props}>
        <CloseIcon className={`${prefixCls}-close-btn`} />
      </BaseItem>
    )
  }
